...
export default function DigitalArrestDetector() {
  ...
  const analyze = async () => {
    ...
    setResult(null)
    try {
      const res = await axios.post("http://localhost:8000/api/digital-arrest/analyze", { text })
      setResult(res.data)
    } catch (e) {
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-xl font-bold mb-1">Digital Arrest Scam Detector</h2>
        <p className="text-white/40 text-sm">
          Paste a suspicious call script, WhatsApp message, or SMS claiming to be from CBI, ED, Police, or TRAI.
        </p>
      </div>
      ...
      <textarea
        ...
        placeholder="Paste suspicious message or call script here... (Hindi, English, or any Indian language)"
